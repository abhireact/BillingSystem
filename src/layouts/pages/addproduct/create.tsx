      ...
      <Card>
        <Grid container>
          ...
          <Grid item sm={6} container sx={{ display: "flex", justifyContent: "center" }}>
            ...
            <Grid item sm={6} sx={{ display: "flex", justifyContent: "flex-start" }}>
              <Checkbox checked={values.not_for_sale} onChange={handleChange} name="not_for_sale" />
              <MDTypography p={2} variant="body2">
                Not For Sale
              </MDTypography>
            </Grid>
            <Grid item sm={6} sx={{ display: "flex", justifyContent: "flex-start" }}></Grid>
            <Grid item sm={12} sx={{ display: "flex", justifyContent: "flex-start" }}>
              <MDTypography variant="body2" fontWeight="bold" py={1}>
                Product Description
              </MDTypography>
            </Grid>
            <Grid item sm={6} sx={{ display: "flex", justifyContent: "flex-start" }} py={2}>
              <MDInput
                multiline
                rows={3}
                variant="standard"
            ...
            <Grid item sm={6} sx={{ display: "flex", justifyContent: "flex-center" }}></Grid>
          </Grid>
          <Grid item sm={12} sx={{ display: "flex", justifyContent: "flex-end" }} p={2} pr={8}>
